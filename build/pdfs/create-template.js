...
exports.PdftoFile = exports.PdftoStream = exports.PDF = void 0;
...
exports.PDF = PDF;
const PdftoStream = (data) => __awaiter(void 0, void 0, void 0, function* () {
    return yield renderer_1.default.renderToStream(react_1.default.createElement(exports.PDF, Object.assign({}, { data })));
});
exports.PdftoStream = PdftoStream;
const PdftoFile = (data, routeFile) => __awaiter(void 0, void 0, void 0, function* () {
    return yield renderer_1.default.renderToFile(react_1.default.createElement(exports.PDF, Object.assign({}, { data })), routeFile);
});
exports.PdftoFile = PdftoFile;
